...
pub fn main() !void {
    ...
    var input_file = try Io.Dir.cwd().openFile(io, input, .{});
    ...
    // TODO: Remove when std.Io.File provides a writer.
    var writer = std.fs.File.adaptFromNewApi(output_file).writer(&write_buf);
